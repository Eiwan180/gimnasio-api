import { Controller, Get, Param, NotFoundException, Delete, Post, Body, BadRequestException, HttpCode, Res } from '@nestjs/common';
...
import { HorarioNoEncontradoError, MiembroNoEncontradoError, CupoLlenoError, InscripcionDuplicadaError } from './dominio/errores.js';
...
export class InscripcionesController {
    ...
    @Post()
    @HttpCode(201)
    async crear(@Body() dto: CrearInscripcionDto, @Res({ passthrough: true }) res: Response) {
